...
To do so by getting the files from [National Oceanic and Atmospheric Administration - NOAA](https://psl.noaa.gov/) specifically [Files](https://downloads.psl.noaa.gov/Datasets/noaa.oisst.v2/) and here we can work with the two files `sst.wkmean.1990-present.nc` and `lsmask.nc`.
