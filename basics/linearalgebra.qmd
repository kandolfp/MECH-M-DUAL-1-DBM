...
For a set $V$ over a field $F$ with the _vectors_ $u, v, w \in V$ and the _scalars_ $\alpha, \beta \in F$ the following assumptions need to hold true to form a vector space:
...
$$ \| \alpha v \| = |\alpha| \| v \| $$
1. subadditivity (often called the triangular inequality) 
$$ \| v + w\| \leq  \| v \| + \| w \|$$.
:::
