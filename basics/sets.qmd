...
We continue our little introduction by looking at _data sets_ in the sense of a list of values that we want to describe more closely.
...
Another helpful histogram is @fig-hist2 showing the number of buildings built per year.
```{python}
# | label: fig-hist2
