...
These notes are intended for engineering students and therefore the mathematical concepts will rarely include rigorous proofs but we give references to books that do.
Nevertheless, if the mathematical concepts are not familiar or need a bit of a refresher we can recommend @Papula-1, @Papula-2, @Papula-3, as well as @Papula2025-ra for exercises.
All of these books are in German but available online for MCI students via the library. 
For our English readers we heard good things about @Kreyszig2011-ih.
