...
![First mode](../_assets/matrixdc/TwoStoryBuildingMode1){#fig-tsm1 width=3.24in}

![Second mode](../_assets/matrixdc/TwoStoryBuildingMode2){#fig-tsm2 width=3.27in}
...
![Low Rank Approximation](../_assets/matrixdc/lowrank){width=5.28in}
