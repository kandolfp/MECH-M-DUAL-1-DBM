...
axs[0].imshow(im_cut, cmap=plt.get_cmap("gray"))
axs[0].set_axis_off()
axs[0].set_title("Cut image")

axs[1].plot((np.abs(lam)))
axs[1].set_yscale("log")
axs[1].set_title("absolute value of the eigenvalues")
axs[1].set_aspect("auto", "box")
plt.show()
```

```{python}
#| label: fig-mci_headquater_compress
#| fig-cap: "Image of MCI I."
#| code-fold: true
#| code-summary: "Show the code for the figure"
import matplotlib.pyplot as plt
...
for i, p in enumerate(rec):
    ...
    A_r = np.real(V[:, 1:r] @ np.diag(lam[1:r], 0) @ Vinv[1:r, :])
