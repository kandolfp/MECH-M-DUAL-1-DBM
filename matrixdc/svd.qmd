...
print(
    r"Additionally we can see that our rotation matrix is closely matched by $U$ (up to signs) from our SVD:"
)
print(
    r"""$$
R_{\frac\pi3} = \left[
\begin{array}{cc} """
    + str(float(round(R[0, 0], 3)))
    + "&"
    + str(float(round(R[1, 0], 3)))
    + r"\\"
    + str(float(round(R[0, 1], 3)))
    + "&"
    + str(float(round(R[1, 1], 3)))
    + r"""\end{array}
\right], \quad U = \left[
\begin{array}{cc}"""
    + str(float(round(U[0, 0], 3)))
    + "&"
    + str(float(round(U[1, 0], 3)))
    + r"\\"
    + str(float(round(U[0, 1], 3)))
    + "&"
    + str(float(round(U[1, 1], 3)))
    + r"""\end{array} \right]
$$"""
```
