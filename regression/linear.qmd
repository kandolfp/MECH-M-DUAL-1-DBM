...
![World population with regression lines normal scale.](../_assets/regression/population1.png){#fig-reg_wp-1 width="70%"}

![World population with regression lines logarithmic scale.](../_assets/regression/population2.png){#fig-reg_wp-2 width="70%"}

Line fit with different norms. Top without outliers, bottom with one outlier.
::::::
:::::
::::
:::
