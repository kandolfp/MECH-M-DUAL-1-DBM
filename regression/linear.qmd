...
Let us model the relation in a linear fashion with the parameters $\beta$
as 
$$
...
There are various possibilities to select the metric for minimizing $\epsilon$ and therefore characterizing the quality of the _fit_.
...
$$
If we go back and we want to solve @eq-fiterror for $\beta$ we have different
