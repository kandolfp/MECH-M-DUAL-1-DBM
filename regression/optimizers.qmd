...
Let us use the results we have obtained so far for a discussion on _model selection_. 
...
In this way we can also say that an overfitted system follows the _training_ set too closely and will not generalize well for another _testing_/_evaluation_ set.
