...
![Signal transition](../_assets/signal/signals.svg){#fig-fft-gec-2}

The electric circuit and the signal transition for our example.
:::::

The transition of the transistor is approximately that of a diode and is illustrated in the $u_{BE}$ vs. $i_C$ diagram on the top left (orange signal). 
The exiting function on the bottom is a normal sine wave with $50\mathrm{Hz}$.
