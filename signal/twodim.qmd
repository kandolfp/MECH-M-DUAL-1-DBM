...
img = axs[0, 0].imshow(A, cmap="gray")
img = axs[1, 0].imshow(np.log(np.abs(Cshift)), cmap="gray")
img = axs[0, 1].imshow(np.log(np.abs(Rshift)), cmap="gray")
img = axs[1, 1].imshow(np.fft.fftshift(np.log(np.abs(D))), cmap="gray")
